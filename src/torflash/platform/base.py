...
class PlatformBackend(ABC):
    ...
    def install_update(self, new_path: str, current_exe: str,
        ...
        Linux: заменяет бинарник и делает execv — НЕ возвращается.
        ...
        macOS: релизный ассет — .app.zip, замена «голого» бинаря невозможна,
        поэтому метод бросает OSError (обновление .app — вручную).
