...
class TestSafeJoin:
    def test_normal_subpath_allowed(self, tmp_path):
        from rutor_search import _safe_join
...
class TestDetectFlashMount:
    def test_missing_base(self, tmp_path):
        from rutor_search import detect_flash_mount
...
class TestVersionTuple:
    def test_with_v_prefix(self):
        from rutor_search import _version_tuple
...
class TestGroupMovieParts:
    def test_split_parts_regroup(self):
        from rutor_search import group_movie_parts, _split_copy_part_name
    ...
    def test_single_file_keeps_name(self):
        from rutor_search import group_movie_parts
...
class TestSizeParserEdges:
    def test_tb(self):
        from rutor_search import parse_size_text, SIZE_FACTORS
...
class TestUpdateChecksumParse:
    def test_parses_sha256sum_format(self):
        from rutor_search import _sha256_from_sumfile
        digest = "a" * 64
